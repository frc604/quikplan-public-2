...
class Robot(object):
    def __init__(self):
        ...
        self.WHEEL_DIA = in2m(3.9)  # m
        self.MODULE_POSITIONS = [
            (MODULE_X_DIST, MODULE_Y_DIST),  # ID 0: FL
            (MODULE_X_DIST, -MODULE_Y_DIST),  # ID 1: FR
            (-MODULE_X_DIST, MODULE_Y_DIST),  # ID 2: BL
            (-MODULE_X_DIST, -MODULE_Y_DIST),  # ID 3: BR
        ]
        ...
        # Motors
        self.MOTOR_MAX_TORQUE  = 0.4  # N*m @ 40A
        self.MOTOR_MAX_RPM  = 3000  # RPM @ 10V
        self.DRIVE_RATIO = 6.86  # 6.86:1
