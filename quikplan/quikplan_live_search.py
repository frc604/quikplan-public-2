...
def plan(robot, TARGETS, plot=False, save_iter_plots=False):
    ...
    opti.subject_to(dist <= in2m(15.0 / 4.0))
    ...
    if plot:
        ...
        writer = Writer(fps=50, metadata={artist:'O'}, bitrate=1000)
        # anim.save('idk2.mp4', writer=writer, dpi=500)
...
if __name__ == "__main__":
    robot = Robot()
    targets = [
        (2.25593469388, -0.27317959183, 0.005),
        (4.49424489796, 1.66551428571, 0.005),
        (4.61761632653, -1.11915510204, 0.005),
    ]
